...
- priorizacion_final: array ordenando los hallazgos más importantes (campo orden 1 = primero). Solo id_rastreo que existan en el input + rationale de 1 línea.
- plan_accion: 4-8 tareas concretas { tarea, impacto, color } donde color es "rojo" | "amarillo" | "verde".
