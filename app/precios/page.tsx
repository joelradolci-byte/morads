  ...
  return (
    <div className="min-h-screen bg-[#FDE8D3] text-[#262B27] font-sans selection:bg-[#F3C3B2]">
      <div className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-black mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>Planes y Funcionalidades</h1>
        <p className="text-xl text-[#657166] mb-12 font-medium">Elegí el plan perfecto para vos y empezá gratis por 14 días.</p>
        
        <div className="bg-white/60 backdrop-blur-xl border border-[#CFD6C4]/60 rounded-3xl p-12 text-left shadow-lg">
          <p className="text-lg text-[#657166] font-medium italic text-center">Matriz de comparación de planes en construcción...</p>
        </div>
      </div>
    </div>
  );
