      ...
      <div className="max-w-[1200px] mx-auto px-6 py-20">
        ...
        <div className="border-t border-[#CFD6C4] pt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Grupo 1 */}
            <div className="bg-white/80 backdrop-blur-md border border-[#CFD6C4]/80 p-8 rounded-3xl shadow-sm">
              ...
              <ul className="space-y-4 text-[#657166] font-medium text-sm">
                <li><strong className="text-[#262B27]">Integración Nativa (OAuth):</strong> El motor invisible. Extracción automática de datos sin copiar ni pegar.</li>
                <li><strong className="text-[#262B27]">Instantáneas (Snapshots):</strong> Memoria a largo plazo que guarda una "foto" del estado de tu cuenta cada semana.</li>
              </ul>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-md border border-[#CFD6C4]/80 p-8 rounded-3xl shadow-sm">
              ...
              <ul className="space-y-4 text-[#657166] font-medium text-sm">
                <li><strong className="text-[#262B27]">GPS del Presupuesto (Pacing):</strong> Sugerencias matemáticas en tiempo real para alcanzar tus objetivos de gasto exactos.</li>
                ...
                <li><strong className="text-[#262B27]">Calculadora de Escalamiento:</strong> Simulación predictiva de ROI para calcular conversiones futuras si subís la inversión.</li>
              </ul>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-md border border-[#CFD6C4]/80 p-8 rounded-3xl shadow-sm">
              ...
              <ul className="space-y-4 text-[#657166] font-medium text-sm">
                <li><strong className="text-[#262B27]">Gráfico Evolutivo de Retención:</strong> La herramienta definitiva para agencias. Mostrale a tu cliente el "Antes y Después" visual de su Score para evitar bajas.</li>
                <li><strong className="text-[#262B27]">Gráficos de Tendencia & Selector de Período:</strong> Visualizá la curva del Score y el ROAS interactuando mes a mes.</li>
                <li><strong className="text-[#262B27]">Deltas Reales:</strong> Matemáticas exactas de incremento o caída porcentual (ej: +12% de conversiones).</li>
              </ul>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-md border border-[#CFD6C4]/80 p-8 rounded-3xl shadow-sm">
              ...
              <ul className="space-y-4 text-[#657166] font-medium text-sm">
                <li><strong className="text-[#262B27]">Razonamiento Basado en Hechos:</strong> Cada sugerencia de la IA vendrá con una explicación técnica y detallada del "porqué".</li>
                <li><strong className="text-[#262B27]">Salud Competitiva (Auction Insights):</strong> Alertas tempranas cuando un competidor te esté robando cuota de mercado.</li>
                <li><strong className="text-[#262B27]">Detector por Segmentación:</strong> Encuentra gasto ineficiente oculto en dispositivos, horarios o ubicaciones puntuales.</li>
                <li><strong className="text-[#262B27]">Monitor de Impacto:</strong> Correlación visual directa entre los cambios que aplicás y la subida de tu Score.</li>
              </ul>
            </div>
          </div>
        </div>
